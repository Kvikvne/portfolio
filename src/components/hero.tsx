...
export function Hero() {
    return (
        <section
            id="home"
            className="min-h-svh py-15 md:py-20 px-6 md:px-0 flex items-center justify-center flex-col"
        >
            ...
            <div className=" flex flex-col gap-1 z-1">
                ...
                <h2 className="text-2xl md:text-4xl mt-2">Software Engineer</h2>
            </div>
            ...
            <div className="mt-10 flex justify-center gap-4 z-1 w-full ">
                <a
                    href="/Kaikane-Anderson-Resume.pdf"
                    target="_blank"
            ...
            <div className="absolute bottom-2 animate-bounce text-sm text-muted-foreground">
